    ...
    <body id="skrollr-body" <?php body_class(); ?>>
        <div id="wrapper">
            <div class="cg-shopping-toolbar">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-12 visible-lg top-bar-right">
                                        ...
                                        if ( $cg_logo ) {
                                            ...
                                            <div class="logo image">
                                                <a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home">
                                                    <span class="helper"></span><img src="<?php echo $cg_logo; ?>" style="max-width: 252.5px !important; max-height: 120px !important; margin-top: -23px;px;" alt="<?php bloginfo( 'name' ); ?>"/></a>
                                            </div>
            ...
            <?php 
            if( is_home() || is_singular( 'product' ) ){
                echo '<ul class="highlights">';
                    echo '<div class="container">';
                        echo '<li class="col-md-4 col-sm-4 creditCard"><i class="fa fa-credit-card" aria-hidden="true"></i>Pague em até 10x sem juros</li>';
                        echo '<li class="col-md-4 col-sm-4 payment discount"><i class="fa fa-barcode" aria-hidden="true"></i>5% de desconto no boleto</li>';
                        echo '<li class="col-md-4 col-sm-4 freight"><i class="fa fa-truck" aria-hidden="true"></i>Frete grátis para são paulo</li>';
                    echo '</div>';
                echo '</ul>';
            }
            ?>
                                ...
                                <?php if ( $cg_catalog == 'disabled' ) { ?>
                                    <div class="cart-wrap">
                                        ...
                                        if ( class_exists( 'WooCommerce' ) ) {
                                            echo cg_woocommerce_cart_dropdown();
                                        }
                                        ?>
                                    </div>
                                <?php } ?>
