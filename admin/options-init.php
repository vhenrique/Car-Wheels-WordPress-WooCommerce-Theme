    ...
    class redux_theme_Redux_Framework_config {
        ...
        public function setSections() {
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    array(
                        'desc' => 'Select where you would like to position your logo',
                        'id' => 'cg_logo_position',
                        'type' => 'select',
                        'title' => 'Header Logo Position',
                        'options' => array(
                            'left' => 'Left',
                            'center' => 'Center',
                        ),
                    ...
                    array(
                        'desc' => 'Choose between a Cart, Basket or Bag',
                        'id' => 'cg_cart_icon_type',
                        'type' => 'select',
                        'title' => 'Select your preferred cart icon style',
                        'options' => array(
                            'cart' => 'Cart',
                            'basket' => 'Basket',
                            'bag' => 'Bag',
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'type' => 'typography',
                        'title' => __( 'Level 2 Heading Typeface', 'redux-framework-demo' ),
                        'text-transform' => true,
                        //'compiler'      => true,  // Use if you want to hook in your own CSS compiler
                        'google' => true, // Disable google fonts. Won't work if you haven't defined your google api key
                        'font-backup' => true, // Select a backup non-google font in addition to a google font
                    ...
                    array(
                        'desc' => 'Set Primary Menu Mega Dropdown banner image height',
                        'id' => 'cg_primary_menu_img_height',
                        'min' => '100',
                        'step' => '1',
                        'max' => '500',
                        'type' => 'slider',
                        'title' => 'Mega Menu Banner Image Height',
                        'default' => '200',
                    ),
                ),
            );
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'output' => array(
                            ...
                            '.wpb_button', '.top-bar-right', '.cg-shopping-toolbar .wpml', 'body .wpb_teaser_grid .categories_filter li a', '#filters button', '.cg-product-wrap a .category', '.lightwrapper h4'
                        ),
                    ...
                    array(
                        ...
                        'type' => 'typography',
                        'title' => __( 'Widget Title Typeface', 'redux-framework-demo' ),
                        //'compiler'      => true,  // Use if you want to hook in your own CSS compiler
                        'google' => true, // Disable google fonts. Won't work if you haven't defined your google api key
                        'font-backup' => true, // Select a backup non-google font in addition to a google font
                        'text-transform' => true,
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'title' => 'Enhanced Variation Dropdown styling enabled?',
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        'desc' => 'Enable or disable product quick view.',
                    ...
                    array(
                        ...
                        'type' => 'typography',
                        'title' => __( 'Price Typeface', 'redux-framework-demo' ),
                        'text-transform' => true,
                        //'compiler'      => true,  // Use if you want to hook in your own CSS compiler
                        'google' => true, // Disable google fonts. Won't work if you haven't defined your google api key
                        'font-backup' => true, // Select a backup non-google font in addition to a google font
                    ...
                    array(
                        ...
                        'type' => 'typography',
                        'title' => __( 'Price Sale Typeface', 'redux-framework-demo' ),
                        'text-transform' => true,
                        //'compiler'      => true,  // Use if you want to hook in your own CSS compiler
                        'google' => true, // Disable google fonts. Won't work if you haven't defined your google api key
                        'font-backup' => true, // Select a backup non-google font in addition to a google font
