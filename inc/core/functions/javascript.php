...
function cg_register_production_js() {
    ...
    if ( !is_admin() ) {
        ...
        // wp_enqueue_script( 'cg_fractionslider', CG_JS . '/fractionslider/jquery.fractionslider.min.js', array( 'jquery' ), '', true );
        // wp_enqueue_script( 'cg_imagesloaded', CG_JS . '/fractionslider/imagesloaded.pkgd.min.js', array( 'jquery' ), '', true );
        wp_enqueue_script( 'cg_nicescroll', CG_JS . '/nicescroll/jquery.nicescroll.min.js', array( 'jquery' ), '', true );
        wp_enqueue_script( 'cg_default', CG_JS . '/default/main.js', array( 'jquery' ), '', true ); 
...
// Remove Woocommerce prettyPhoto as we use our own responsive lightbox
