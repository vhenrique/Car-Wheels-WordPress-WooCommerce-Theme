...
function cg_woocommerce_cart_dropdown() {
    ...
    <?php } else { ?> 
        ...
        if ( sizeof( $woocommerce->cart->cart_contents ) > 0 ) :
            ...
            echo '<li class="buttons"><a href="' . $woocommerce->cart->get_cart_url() . '" class="button">' . __( 'View Cart', 'commercegurus' ) . '</a> <a href="' . $woocommerce->cart->get_checkout_url() . '" class="button checkout">Finalizar compra</a></li>';
        endif;
    ...
    function cg_header_add_to_cart_fragment( $fragments ) {
        ...
        <?php } ?>
            ...
            if ( sizeof( $woocommerce->cart->cart_contents ) > 0 ) :
                ...
                echo '<li class="buttons"><a href="' . $woocommerce->cart->get_cart_url() . '" class="button">' . __( 'View Cart', 'commercegurus' ) . '</a>';
                echo '<a href="' . $woocommerce->cart->get_checkout_url() . '" class="button checkout TESTE">Finalizar compra</a></li>';
            endif;
